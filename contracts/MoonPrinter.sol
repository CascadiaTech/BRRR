...
contract MoonPrinter is ERC20, Ownable {
    ...
    Taxes public sellTaxes = Taxes(6, 3);
    uint256 public totalBuyTax = 5;
    uint256 public totalSellTax = 9;

    constructor(address _treasury, address _devWallet)
        ERC20("Moon Printer", "BRRR")
    {
        dividendTracker = new DividendTracker();
        setSwapTokensAtAmount(10000000000); //
        setDevWallet(_devWallet);
        updateMaxWalletAmount(640000000000);
        setTreasuryWallet(_treasury);
        ...
        */
        _mint(owner(), 32000000000000 * (10**18));
    }
    ...
    function updateMaxWalletAmount(uint256 newNum) public onlyOwner {
        require(newNum > (320000000000), "Cannot set maxWallet lower than 1%");
    ...
    function setMaxBuy(uint256 maxBuy)
        ...
        onlyOwner
    {
        require(maxBuy >= 320000000000, "Cannot set maxbuy lower than 1% ");
